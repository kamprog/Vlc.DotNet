...
namespace Vlc.DotNet.Core.Interop.Vlc
{
    internal class VlcMediaListPlayer : VlcMediaPlayer
    {
        ...
        public override VlcState State
        {
            get
            {
                VlcState rtn = InteropMethods.libvlc_media_list_player_get_state(p_media_player, ref p_ex);
                p_ex.CheckException();
                return rtn;
            }
        }
        ...
        {
            SyncEvents();
            InteropMethods.libvlc_media_list_player_play(p_ml_player, ref p_ex);
            p_ex.CheckException();
        }
        #endregion
        ...
        {
            SyncEvents();
            InteropMethods.libvlc_media_list_player_play_item_at_index(p_ml_player, Index, ref p_ex);
            p_ex.CheckException();
        }
        #endregion
        ...
        {
            SyncEvents();
            InteropMethods.libvlc_media_list_player_play_item(p_ml_player, Media.p_media, ref p_ex);
            p_ex.CheckException();
        }
        #endregion
        ...
        {
            SyncEvents();
            InteropMethods.libvlc_media_list_player_pause(p_ml_player, ref p_ex);
            p_ex.CheckException();
        }
        #endregion
        ...
        {
            SyncEvents();
            InteropMethods.libvlc_media_list_player_stop(p_ml_player, ref p_ex);
            p_ex.CheckException();
        }
        #endregion
